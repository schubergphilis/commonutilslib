...
setup(
    name='''commonutilslib''',
    version=version,
    description='''A library with some common utility methods for python like tempdir and Pushd''',
    long_description=readme + '\n\n' + history,
    author='''Costas Tyfoxylos''',
    author_email='''ctyfoxylos@schubergphilis.com''',
    url='''https://github.com/schubergphilis/commonutilslib.git''',
    packages=find_packages(where='.', exclude=('tests', 'hooks', '_CI*')),
    package_dir={'''commonutilslib''':
                 '''commonutilslib'''},
